...
The Google Chrome extension was majority developed in Visual Studio Code with JavaScript, HTML, and CSS
...
\\The script then enters a set interval function which runs every second. This function first 
checks if there is any value stored for the pause start time. If there is, 
