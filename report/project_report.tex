...
The Google Chrome extension was developed in Visual Studio Code with JavaScript 
...
scripts for the background service worker, content scripts, and various permissions. 
\\The popup script contains the main control menu for the extension. This script runs each time the popup page 
is opened and firsts checks shared storage to see what state the popup menu should be in. The possible states 
...
\\(I sent an email asking if the amount of detail I am including is correct, so this might change if it is not correct)
